EGS.Globe = EGS.Class(EGS.Earth,
{
	...
	_vsCode : "uniform mat4 mvpMatrix; attribute vec3 v3Position;attribute vec3 av3Color;varying vec3 vv3Color;attribute vec2 aTextureCoord;varying vec2 vTextureCoord;void main(void){vv3Color = av3Color;vTextureCoord = aTextureCoord;gl_Position =  mvpMatrix * vec4(v3Position, 1.0);}",
